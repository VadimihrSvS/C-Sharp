...
namespace Lab_8
{
    class Cars : IDrive, IComparable //класс "автомобиль", реализует интерфейс "езда"
    {
        ...
        public Cars(string mr) : this(1.0, "X", "X", 0)
        {
            Mark = mr;
        }
        ...
        {
            return "Автомобиль" + "\tМарка: " + Mark + "\tМодель: " + Model;
        }

        public virtual string GetInfo()
        {
            return "\tАвтомобиль\n" + "Масса: " + Weight + " т" + "\tМарка: " + Mark
        ...
        {
            if ((obj as Cars).Mark == this.Mark) { return true; }
            else return false;
        }
